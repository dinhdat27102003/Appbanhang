...
public class New_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_new_, container, false);
        sanPhamList = genera(load(Server.Duongdansanphammoinhat));
        recyclerView = rootview.findViewById(R.id.new_recyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new GridLayoutManager(getActivity(),2));
        newAdapter = new NewAdapter(sanPhamList,getActivity());
